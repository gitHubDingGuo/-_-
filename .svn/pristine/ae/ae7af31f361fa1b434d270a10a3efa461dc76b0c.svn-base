...
<title>注册</title>
<link rel="shortcut icon" href="${pageContext.request.contextPath}/static/img/login/logo-b.png" />
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/static/regist/css/bootstrap.min.css">
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/static/regist/css/gloab.css">
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/static/regist/css/index.css">
<link href="${pageContext.request.contextPath}/static/regist/pictureYanZheng/css/jquery.idcode.css"
	type="text/css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/static/regist/css/style.css" rel="stylesheet"
	type="text/css" />
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/regist/js/jquery-1.11.1.min.js"></script>

<script type="text/javascript" src="${pageContext.request.contextPath}/static/regist/register.js"></script>

<script
	src="${pageContext.request.contextPath}/static/regist/pictureYanZheng/js/jquery-1.12.3.min.js"></script>
<script src="${pageContext.request.contextPath}/static/regist/pictureYanZheng/js/jquery.idcode.js"></script>
				...
				<div class="reg-box" id="verifyCheck" style="margin-top: 20px;">
					<div class="part1">
						...
						<div class="item col-xs-12">
							...
							<div class="f-fl item-ifo">
								<input type="text" class="txt03 f-r3 required" keycodes="email"
									...
									class="focus">请填写用户本人邮箱地址</label> <label class="focus valid" id="xianshi2"></label>
							</div>
						</div>
						...
						<div class="item col-xs-12">
                           ...
                           -->
								<input type='radio' name='sex' value='男' checked="checked" id='sex'> 男 <input
								 	id='sex' type='radio' name='sex' value='女' > 女 <input
									 id='sex' type='radio' name='sex' value='保密' > 保密
						...
						<div class="item col-xs-12">
							...
							<div class="f-fl item-ifo">
								...
								<div class="go-regist">
									已有帐号,请<a href="${pageContext.request.contextPath}" class="link">登录</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="part4 text-center" style="display: none">
						...
						<p class="c-666 f-mt30 f-mb50" id="low">
							页面将在 <strong id="times" class="f-size18">5</strong> 秒钟后，跳转到登录界面，若未跳转 <a
								href="${pageContext.request.contextPath}" class="c-blue">点击此处</a>手动跳转
						</p>
					</div>
				</div>
			</div>
	...
	<div id="footer">
		<div class="dblock">
			<div class="inline-block1">
				<img src="${pageContext.request.contextPath}/static/img/login/logo-b.png" width="75" height="50">
			</div>
