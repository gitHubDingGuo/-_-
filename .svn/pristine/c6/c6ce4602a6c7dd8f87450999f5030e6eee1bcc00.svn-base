...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/static/person/css/jiazaitoubu.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/static/person/css/css.css">
<script src="${pageContext.request.contextPath}/static/person/js/jquery-1.8.3.min.js"></script>
<script src="${pageContext.request.contextPath}/static/person/index2.js"></script>
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/static/person/css/center.css">

<!--城市联动-->
<link rel="stylesheet" type="text/css"
	href=${pageContext.request.contextPath}/static/person/city/city.css">
<script src="${pageContext.request.contextPath}/static/person/city/Popt.js"></script>
<script src="${pageContext.request.contextPath}/static/person/city/cityJson.js"></script>
<script src="${pageContext.request.contextPath}/static/person/citySet.js"></script>
<!-- 上传头像 -->
<script src="${pageContext.request.contextPath}/static/person/headImage/head/jquery.min.js"></script>

<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/static/person/headImage/css/bootstrap.min.css">
<link href="${pageContext.request.contextPath}/static/person/headImage/head/cropper.min.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/static/person/headImage/head/sitelogo.css"
	rel="stylesheet">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/static/person/headImage/css/font-awesome.min.css">

<script src="${pageContext.request.contextPath}/static/person/headImage/head/bootstrap.min.js"></script>
<script src="${pageContext.request.contextPath}/static/person/headImage/head/cropper.js"></script>
<script src="${pageContext.request.contextPath}/static/person/headImage/head/sitelogo.js"></script>
<script src="${pageContext.request.contextPath}/static/person/headImage/head/html2canvas.js"></script>
<!-- 生日插件 -->
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/person/birthday/jedate/jedate.js"></script>
<style>
.datainp {
	width: 200px;
	height: 30px;
...
<!--页脚 -->
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/static/person/footer/index.css">
</head>
<%
