...
public class FileController {
	...
	public List<FileVo> fundFile(HttpSession session ,String type) {     
		 ...
		 /* String userId=(String) map.get("userId");*/
		   ...
		   if(type.equals("All")) {
			    ...
			    list=ifolderSerivce.folder_fileLists1(userId,0);
			    return list;
			   ...
			   list=new ArrayList<FileVo>();
			    String userId="user_123";
			    list=ifolderSerivce.trashLists(userId,0);
			    return list;
		   }
		    else {
			    list=new ArrayList<FileVo>();
			    String userId="user_123";
			    session.setAttribute("searchContext", type);
	...
	public CapacityVo capacity(HttpSession session) {
		CapacityVo capacityVo=new CapacityVo();
		/*String userId=session.getAttribute("userId");*/
		String userId="user_123";
		capacityVo=IUserService.capacity(userId);
		System.out.println(capacityVo.toString()+"----------------------------------------fileVo------fubded8980898");
		return capacityVo;
	}
	...
	public List<FileVo> group(@RequestParam("group") String type,HttpSession session) {
	    List<FileVo> list = null;
		/*String userId=session.getAttribute("userId");*/
		String searchContext=(String) session.getAttribute("searchContext");
		System.out.println(searchContext+"----------serarcontext");
		System.out.println(type+"----------type");
		String userId="user_123";
		list=ifolderSerivce.group(userId,type,searchContext);
		return list;
