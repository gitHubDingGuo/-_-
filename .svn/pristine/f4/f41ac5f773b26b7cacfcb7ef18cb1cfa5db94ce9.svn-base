...
<head>
    ...
    <title>忘记密码</title>
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/static/regist/css/bootstrap.min.css">
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/static/regist/css/gloab.css">
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/static/regist/css/index.css">
    <link href="${pageContext.request.contextPath}/static/regist/pictureYanZheng/css/jquery.idcode.css" type="text/css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/static/regist/css/style.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/regist/js/jquery-1.11.1.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/regist/forgetPassword.js"></script>
</head>
...
<div id="footer">
    <div class="dblock">
        <div class="inline-block1"><img src="${pageContext.request.contextPath}/static/img/login/logo-b.png" width="75" height="50"></div>
