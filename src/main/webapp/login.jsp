...
<link rel="shortcut icon" href="${pageContext.request.contextPath}/static/img/logo-b.png" />
<link href="${pageContext.request.contextPath}/static/css/style/style.css" rel="stylesheet"
	type="text/css" />
<style>
/*滚动条*/
::-webkit-scrollbar {
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/js/jquery.i18n.properties-1.0.9.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/js/jquery-ui-1.10.3.custom.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/jquery.validate.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/static/js/page_regist2.js"></script>
...
<script language="javascript" type="text/javascript">
	...
	function checkUserNamePass() {
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/user/login.action", //(默认: 当前页地址) 发送请求的地址
...
<body class="loginbody" onload="getCookie();">
	<div id="All-Content2">
		<div class="dataEye">
			...
			<div
				style="background: url(${pageContext.request.contextPath}/static/img/bg.png) no-repeat; background-size: cover; width: 1345px;">
				<div class="loginbox registbox"
					...
					<div class="login-content reg-content">
						...
						<form id="signupForm" action="${pageContext.request.contextPath}/user/yunDisk.action" method="post">
					...
					<div class="go-regist">
						没有帐号,请<a href="${pageContext.request.contextPath}/user/register.action" class="link">注册</a>
					</div>
				</div>
			</div>
			<div id="footer">
				<div class="dblock">
					<div class="inline-block1" style="padding-top: 6px;">
						<img src="${pageContext.request.contextPath}/static/img/logo-b.png" width="75" height="50">
					</div>
